    ...
    return (
        <QueryInfiniteScroll
            ...
            {/* <div className='flex items-center flex-col mt-10'> */}
                {
                (res) => {
                    if (res === undefined) return null; // Handle undefined response gracefully  
                    ...
                    return sliceData.map((page,index) => (
                        ...
                        <div className='flex justify-between items-center'>
                            ...
                            <small className='text-slate-600 font-semibold'>user:{page.userId}</small>
                            </div>
                        ...
                        <div className='w-[88%] border border-slate-200 mx-auto px-2 py-2 flex justify-between'>
                            ...
                            <small className="text-slate-900 text-opacity-50">like:1.2k</small>
                            </div>
                            <small className='text-cyan-600'>50comments</small>
                        </div>
                        <CardFooter className="flex justify-between py-3">
                            ...
                            <Dialog className="flex">
                                <DialogTrigger className="relative right-3 hover:cursor-pointer hover:text-cyan-600" onClick={() => handleCommentClick(page.id)}>
                                    <small>comment</small>  
                                </DialogTrigger>
                                <DialogContent>
                                    ...
                                    <div className='flex justify-between'>
                                        ...
                                        <small className='text-slate-600 font-semibold ml-2'>user:{page.userId}</small>
                                        </div>
                                        <small className='text-slate-600 relative right-7'>date: 8-8-2024</small>
                                    </div>
                                    ...
                                    <div className='w-full border border-slate-200 px-5 py-2 flex justify-between'>
                                        ...
                                        <small className='text-cyan-600'>50comments</small>
                                        <small className="relative right-5 text-slate-900 text-opacity-50">share</small>
                                    </div>
                                    </DialogFooter>
                                    ...
                                    {loading ? (  
                                        ...
                                        <Comment index={index} key={index}/>
                                        ))  
                                    )} 
                                    </div>  
                                    <div className="h-auto border border-slate-200 p-3 relative ">  
                                    <div className="w-full gap-2 flex">
                                        <Textarea placeholder="Type your message here." className="active:ring-0 placeholder:text-slate-900 placeholder:text-opacity-60 outline-none" />
                                        <Button className="min-w-[60px] bg-cyan-500 hover:bg-cyan-600 text-[.8rem]">Send</Button>
                                    </div>
                                    </div>
                                </DialogContent>
                            </Dialog>
